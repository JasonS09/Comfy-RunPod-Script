...
LORA_MODELS=(
    "https://huggingface.co/dominic1021/lora/resolve/main/lcm_lora_sd15.safetensors"
    "https://huggingface.co/conrevo/AnimateDiff-A1111/resolve/main/lora/mm_sd15_v3_adapter.safetensors"
)
